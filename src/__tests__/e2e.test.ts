...
tell application "Photos"
  ...
  return albumList
          ...
          case 'photos_get_album_photos': {
            ...
            if (!album) {
              return {
                content: [{ type: 'text', text: 'Error: album is required' }],
                isError: true,
              };
            }
            const result = runAppleScriptMulti(
              `tell application "Photos" to get photos of album "${album}" limit ${limit}`
            );
          ...
          case 'photos_create_album': {
            ...
            const result = runAppleScriptMulti(
              `tell application "Photos" to make new album named "${albumName}"`
            );
            return { content: [{ type: 'text', text: result }] };
          }
          ...
          case 'photos_delete_album': {
            ...
            const result = runAppleScriptMulti(
              `tell application "Photos" to delete album "${album}"`
            );
            return { content: [{ type: 'text', text: result }] };
          }
          ...
          case 'photos_get_recent': {
            ...
            const result = runAppleScriptMulti(
              `tell application "Photos" to get recent photos limit ${limit}`
            );
          ...
          case 'photos_get_favorites': {
            const limit = (args as { limit?: number }).limit || 50;
            const result = runAppleScriptMulti(
              `tell application "Photos" to get favorites limit ${limit}`
            );
          ...
          case 'photos_get_photo_info': {
            ...
            if (!photoId) {
              return {
                content: [{ type: 'text', text: 'Error: photoId is required' }],
                isError: true,
              };
            }
            const result = runAppleScriptMulti(
              `tell application "Photos" to get info of photo id "${photoId}"`
            );
            return { content: [{ type: 'text', text: result }] };
          }
          ...
          case 'photos_search': {
            ...
            const result = runAppleScriptMulti(
              `tell application "Photos" to search for "${query}" limit ${limit}`
            );
            return { content: [{ type: 'text', text: result }] };
          }
          ...
          case 'photos_search_by_date': {
            ...
            if (!startDate || !endDate) {
              return {
                content: [{ type: 'text', text: 'Error: startDate and endDate are required' }],
                isError: true,
              };
            }
            const result = runAppleScriptMulti(
              `tell application "Photos" to search by date from "${startDate}" to "${endDate}" limit ${limit}`
            );
            return { content: [{ type: 'text', text: result }] };
          }
          ...
          case 'photos_export': {
            ...
            const result = album
              ? runAppleScriptMulti(
                  `tell application "Photos" to export album "${album}" to "${destination}" limit ${limit}`
                )
              : runAppleScriptMulti(
                  `tell application "Photos" to export selection to "${destination}" limit ${limit}`
                );
            return { content: [{ type: 'text', text: result }] };
          }
          ...
          case 'photos_export_photo': {
            ...
            mockedExecSync(`mkdir -p '${destination}'`);
            const result = runAppleScriptMulti(
              `tell application "Photos" to export photo id "${photoId}" to "${destination}"`
            );
            return { content: [{ type: 'text', text: result }] };
          }
          ...
          case 'photos_set_favorite': {
            ...
            if (!photoId || favorite === undefined) {
              return {
                content: [{ type: 'text', text: 'Error: photoId and favorite are required' }],
                isError: true,
              };
            }
            const result = runAppleScriptMulti(
              `tell application "Photos" to set favorite of photo id "${photoId}" to ${favorite}`
            );
            return { content: [{ type: 'text', text: result }] };
          }
          ...
          case 'photos_open_album': {
            ...
            return {
              content: [{ type: 'text', text: `Opened Photos app. Navigate to album: ${album}` }],
            };
          }
          ...
          case 'photos_import': {
            ...
            const result = album
              ? runAppleScriptMulti(
                  `tell application "Photos" to import "${path}" into album "${album}"`
                )
